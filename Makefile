# ====================================================================================
# Setup Project
PROJECT_NAME := provider-taurus
PROJECT_REPO := github.com/SuryaLeon/$(PROJECT_NAME)
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Taurus CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Taurus controllers
...
# This target prepares repo for your provider by replacing all "taurus"
