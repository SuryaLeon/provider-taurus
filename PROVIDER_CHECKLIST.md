...
The [provider-taurus](https://github.com/SuryaLeon/provider-taurus) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-taurus](https://github.com/crossplane-contrib/provider-jet-taurus) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/SuryaLeon/provider-taurus/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/SuryaLeon/provider-taurus/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/SuryaLeon/provider-taurus/blob/main/hack/boilerplate.go.txt](https://github.com/SuryaLeon/provider-taurus/blob/main/hack/boilerplate.go.txt)
...
The [provider-taurus](https://github.com/SuryaLeon/provider-taurus)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/SuryaLeon/provider-taurus/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/SuryaLeon/provider-taurus/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue tauruss (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/SuryaLeon/provider-taurus/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Tauruss: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/SuryaLeon/provider-taurus/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
